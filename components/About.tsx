...
const About: React.FC = () => {
  return (
    ...
    // style={{ paddingLeft: '128px', paddingRight: '128px' }} // Optional for larger screens
  >
    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      ...
      <div className="text-left space-y-4 text-gray-500">
        ...
        <ul className="grid w-full sm:w-2/3 grid-cols-2 sm:grid-cols-3 gap-2 text-sm">
          ...
          <li className="before:content-['▹'] flex before:mr-3 before:text-accent">TailwindCSS</li>
